...
checked in at `crates/relon-ir/src/normalization_data.rs`, shared by
...
Run:
    python3 crates/relon-ir/tools/gen_normalization_tables.py \
        --ucd /path/to/ucd14 \
        --out crates/relon-ir/src/normalization_data.rs
...
def emit(
    ...
    lines: List[str] = []
    lines.append("// AUTO-GENERATED by crates/relon-ir/tools/gen_normalization_tables.py")
