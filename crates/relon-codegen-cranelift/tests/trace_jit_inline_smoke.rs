...
//!
//! These tests exercise [`relon_codegen_cranelift::compile_inline_host_fn`]
...
fn inline_const_trace(value: i64) -> relon_codegen_cranelift::InlineHostFn {
...
fn inline_guard_fire_routes_through_deopt_path() {
    ...
    let mut ctx = TraceContext::with_hooks(16, relon_codegen_cranelift::default_host_hooks());
