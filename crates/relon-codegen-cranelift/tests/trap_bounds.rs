...
use relon_codegen_cranelift::{AotEvaluator, SandboxConfig, SandboxState, TrapKind};
...
fn raise_trap_records_bounds_code_through_the_host_helper() {
    ...
    let vt = std::sync::Arc::new(relon_codegen_cranelift::CapabilityVtable::with_capacity(0));
